					...
					<div id="main">
						...
						<!-- Content -->
							<section id="content" class="main">
								<h2>Mon travail en tant que développeur de pages web responsives consistait à concevoir et à créer des sites web qui sont non seulement esthétiques, mais aussi fonctionnels et accessibles sur tous types d’appareils. <li> L’objectif principal était de garantir une expérience utilisateur optimale, quelle que soit la taille de l'écran. Voici les principales missions que j’effectuais dans ce cadre : </li>
								...
								<p>
									...
									<ul>
                                        <li>
                                          <strong>1. Analyse des besoins et conception de la structure du site</strong>
                                          <br>
                                        ...
                                        <li>
                                          <strong>2. Développement de la structure HTML5</strong>
                                          <br>
                                          Une fois la conception validée, je passais à la création du code HTML5. Cela consistait à créer le squelette des pages avec des éléments sémantiques. Je m'assurais que le contenu était bien hiérarchisé et facile à indexer par les moteurs de recherche (SEO). Par exemple, je structurai le texte avec des éléments comme les entêtes, les sections, les articles et le pied de page pour améliorer la lisibilité du contenu.
                                        </li>
                                        
                                        <br>
                                      
                                        <li>
                                          <strong>3. Stylisation avec CSS3</strong>
                                          <br>
                                        ...
                                        <li>
                                          <strong>6. Mise en ligne et maintenance</strong>
                                          <br>
                                        ...
                                        <li>
                                          <strong>7. Suivi de la performance et de l’accessibilité</strong>
                                          <br>
